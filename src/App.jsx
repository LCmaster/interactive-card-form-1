...
function App() {
  ...
  return (
    <div className="font-spaceGrotesk font-medium text-veryDarkViolet ">
      ...
      <div className="mx-auto w-[327px] lg:w-auto px-6 py-8 lg:px-8 flex flex-col justify-center lg:flex-row items-center lg:gap-[124px]">
        <div className="w-[327px] lg:w-auto lg:flex lg:flex-col-reverse lg:justify-end gap-[37px]">
